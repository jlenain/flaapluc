...
class autoLC:
    ...
    def __init__(self,file="/home/jlenain/data/fermi/local/automaticLightCurve/listSources.txt",customThreshold=False,daily=False,longTerm=False,yearmonth=None,mergelongterm=False):
        self.file=file
