...
class autoLC:
    ...
    def __init__(self,file="/home/fermi/local/automaticLightCurve/common/listSources.txt",customThreshold=False,daily=False,longTerm=False,yearmonth=None,mergelongterm=False):
        self.file=file
...
""" %('http://www.lsw.uni-heidelberg.de/projects/hess/Fermi/intern/index.html')
